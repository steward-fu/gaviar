...
#if CONFIG_D3D_COMPRESS_EN
	int mb_len, mb_min_bits_ratio, mb_max_bits_ratio, align;
	int wth, kb_wnum, kb_hnum, width_bitdepth;
...
#if defined CONFIG_WDR && !defined ISP_601
...
#if defined SUPPORT_ISP_TDM && !defined ISP_601
...
int sunxi_isp_subdev_init(struct v4l2_subdev *sd, u32 val)
{
	...
	if (val) {
		...
		bsp_isp_set_save_load_addr(isp->id, (dma_addr_t)isp->isp_save_load.dma_addr);
		//bsp_isp_adbset_save_load_addr(isp->id, (dma_addr_t)isp->isp_save_load.dma_addr); //set first save_load address
#endif
...
#if !defined CONFIG_ARCH_SUN8IW16P1 && !defined CONFIG_ARCH_SUN8IW19P1 && !defined CONFIG_ARCH_SUN50IW10P1 && !defined CONFIG_ARCH_SUN55IW3
