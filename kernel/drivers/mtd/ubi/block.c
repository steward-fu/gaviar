...
/* maxinum number of works*/
#define UBIBLOCK_MAX_ACTIVE_WORKS CONFIG_MTD_UBI_BLOCK_MAX_ACTIVE_WORKS
...
int ubiblock_create(struct ubi_volume_info *vi)
{
	 ...
	 */
	dev->wq = alloc_workqueue("%s", WQ_SYSFS, UBIBLOCK_MAX_ACTIVE_WORKS, gd->disk_name);
	if (!dev->wq) {
		ret = -ENOMEM;
		goto out_free_queue;
	}
