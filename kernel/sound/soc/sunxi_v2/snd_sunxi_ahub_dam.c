...
static inline void snd_sunxi_clk_exit(struct sunxi_ahub_clk *clk)
{
	SND_LOG_DEBUG(HLOG, "\n");
...
static inline int snd_sunxi_clk_enable(struct sunxi_ahub_clk *clk)
{
	int ret = 0;
...
static inline void snd_sunxi_clk_disable(struct sunxi_ahub_clk *clk)
{
	SND_LOG_DEBUG(HLOG, "\n");
