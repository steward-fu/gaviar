...
extern int snd_sunxi_hdmi_get_dai_type(struct device_node *np, unsigned int *dai_type);
extern int snd_sunxi_hdmi_init(void);
extern int snd_sunxi_hdmi_hw_params(struct snd_pcm_hw_params *params, enum HDMI_FORMAT hdmi_fmt);
...
static inline int snd_sunxi_hdmi_get_dai_type(struct device_node *np, unsigned int *dai_type)
{
