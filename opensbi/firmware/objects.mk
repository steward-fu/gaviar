...
ifdef F133_SRAM
firmware-genflags-y += -DF133_SRAM=$(F133_SRAM)
endif

ifdef DTB_BASE
firmware-genflags-y += -DDTB_BASE=$(DTB_BASE)
endif

ifdef KERNEL_BASE
firmware-genflags-y += -DKERNEL_BASE=$(KERNEL_BASE)
endif

ifdef OPENSBI_BASE
firmware-genflags-y += -DOPENSBI_BASE=$(OPENSBI_BASE)
endif
